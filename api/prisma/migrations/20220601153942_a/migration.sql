...
-- AddForeignKey
ALTER TABLE `commentaire` ADD CONSTRAINT `commentaire_writtenById_fkey` FOREIGN KEY (`writtenById`) REFERENCES `user`(`email`) ON DELETE RESTRICT ON UPDATE CASCADE;
